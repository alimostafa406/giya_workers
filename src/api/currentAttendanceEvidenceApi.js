...
export const getAttendanceEvidenceRangeRequest = async (dateFrom, dateTo) => {
...
export const getCurrentAttendanceEvidenceRequest = (attendanceDate) => getAttendanceEvidenceRangeRequest(attendanceDate, attendanceDate)
